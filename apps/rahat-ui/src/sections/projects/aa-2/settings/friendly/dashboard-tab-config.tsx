...
const SETTING_NAME = 'DASHBOARD_TAB_CONFIG';
...
const TAB_OPTIONS: { value: string; label: string }[] = [
  { value: 'floodSurveyData', label: 'Flood Survey Data' },
  { value: 'beneficiaryDemographics', label: 'Beneficiary Demographics' },
  { value: 'tokenStats', label: 'Token Stats' },
  { value: 'accessInclusion', label: 'Access & Inclusion' },
  { value: 'communicationOutreach', label: 'Communications & Outreach' },
  { value: 'heatwaveSurveyData', label: 'Heatwave Survey Data' },
];
...
export default function DashboardTabConfigEditor({ submitRef }: IProps) {
