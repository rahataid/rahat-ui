...
import { useStakeholders, useStakeholdersStore, usePagination, useUpdateStakeholdersGroups } from '@rahat-ui/query';
...
export default function EditStakeholdersGroups({ stakeholdersGroupDetail }: any) {
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(handleUpdateStakeholdersGroups)}>
                <div className="p-4 h-[calc(100vh-130px)] bg-card">
                    <h1 className="text-lg font-semibold mb-6">Edit : Stakeholders Groups</h1>
