...
export function RainFallMonitor({
  ...
  return (
    <div className="border rounded-sm grid grid-cols-4 shadow-sm ">
      <div className="p-4 col-span-1 pr-1">
        <div className="grid grid-cols-1">
          <div className=" flex text-wrap justify-between gap-2 ">
            <Heading
              title={name}
            ...
            <div>
              <Badge
                className={`text-xs text-wrap font-normal ${
      ...
      <div className="w-full  p-4 col-span-3 ">
