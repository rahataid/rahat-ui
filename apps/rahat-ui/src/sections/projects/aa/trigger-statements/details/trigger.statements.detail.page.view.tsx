        ...
        <div className="h-[calc(100vh-65px)] bg-secondary p-4">
            <div className="flex justify-between">
                <div className="flex gap-4 items-center">
                    <ArrowLeft size={25} strokeWidth={1.5} className="cursor-pointer" onClick={() => router.back()} />
                    <h1 className="text-xl font-semibold">Demo title for Trigger</h1>
                </div>
                <div className="flex gap-4 items-center">
                    ...
                    <Button type="button" className="px-8">Trigger</Button>
                </div>
            </div>
            <TriggerDetailCards />
            <div className="grid grid-cols-2 gap-4 mt-4 h-[calc(100vh-252px)]">
                <TriggerDetailCard />
                <TriggerActivityListCard />
            </div>
        </div>
    )
}