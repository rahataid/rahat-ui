...
import { usePagination, useStakeholdersGroups, useStakeholdersGroupsStore } from '@rahat-ui/query';
...
export default function StakeholdersGroupsListView() {
    ...
    const { stakeholdersGroups, stakeholdersGroupsMeta } = useStakeholdersGroupsStore((state) => ({
    ...
    return (
        <div className="rounded border bg-card">
            ...
            <CustomPagination
                meta={stakeholdersGroupsMeta || { total: 0, currentPage: 0, lastPage: 0, perPage: 0, next: null, prev: null }}
