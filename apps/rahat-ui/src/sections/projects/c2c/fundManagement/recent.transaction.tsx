...
import { TransactionsObject } from './types';
...
export default function RecentTransaction() {
  ...
  useEffect(() => {
    const transactionsObject: TransactionsObject = data.data;
    const transactionList = mergeTransactions(transactionsObject);
  }, []);
