...
const hideNotificationPaths = ['/projects/aidlink'];
...
export function Nav({ hasDefaultHeader = true }) {
  ...
  const hideNotification = hideNotificationPaths.includes(pathname);
    ...
    hasDefaultHeader && (
      <div className="h-14 fixed w-[calc(100vw-56px)] flex justify-between gap-4 items-center p-2 border-b z-40">
        ...
        <div className="flex space-x-6 items-center">
          {!hideNotification && <NotificationButton unreadCount={3} />}
          <ConnectWallet />
          <DropdownMenu>
            <DropdownMenuTrigger>
