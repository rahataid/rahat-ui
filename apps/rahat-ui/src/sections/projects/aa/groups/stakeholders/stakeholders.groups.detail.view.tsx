                                ...
                                <AlertDialog>
                                    ...
                                    <AlertDialogContent>
                                        ...
                                        <AlertDialogFooter>
                                            ...
                                            <AlertDialogAction
                                                onClick={() => removeStakeholdersGroup(stakeholdersGroupDetail?.uuid)}
                                            >
                                                Continue
                                            </AlertDialogAction>
                                        </AlertDialogFooter>
            ...
            {!showEdit ? (
                <div className="flex flex-col gap-2 m-2 p-2 border rounded">
                    ...
                    <div className="pl-2">
                        ...
                        {stakeholdersGroupDetail?.stakeholders?.map((member: any) => <p>{member?.name} ({member?.designation})</p>
                        )}
                    </div>
                </div>
            ) : <EditStakeholdersGroups stakeholdersGroupDetail={stakeholdersGroupDetail} />}
        </>
    );
}
