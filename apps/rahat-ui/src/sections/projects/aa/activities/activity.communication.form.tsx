...
import { z } from 'zod';
import { useStakeholdersGroups, useStakeholdersGroupsStore } from '@rahat-ui/query';
...
export default function ActivityCommunicationForm() {
    const { id } = useParams();
    ...
    const handleCreateCommunication = async (data: z.infer<typeof FormSchema>) => {
        alert("submitted");
