...
export const rahatDonorAbi = [
  ...
  },
  {
    ...
    name: 'RahatTreasury',
    outputs: [
      { name: '', internalType: 'contract IRahatTreasury', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
 ...
 */
export const useReadRahatDonorRahatTreasury =
  /*#__PURE__*/ createUseReadContract({
    abi: rahatDonorAbi,
 ...
 */
export const useReadRahatDonorTokenToDollarValue =
  /*#__PURE__*/ createUseReadContract({
    abi: rahatDonorAbi,
...
/**
 * Wraps __{@link useWriteContract}__ with `abi` set to __{@link rahatDonorAbi}__ and `functionName` set to `"mintTokens"`
 */
export const useWriteRahatDonorMintTokens =
  /*#__PURE__*/ createUseWriteContract({
    abi: rahatDonorAbi,
...
/**
 * Wraps __{@link useSimulateContract}__ with `abi` set to __{@link rahatDonorAbi}__ and `functionName` set to `"mintTokens"`
 */
export const useSimulateRahatDonorMintTokens =
  /*#__PURE__*/ createUseSimulateContract({
    abi: rahatDonorAbi,
    functionName: 'mintTokens',
  })
